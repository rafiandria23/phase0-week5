/**
 * HACKTIV8 Phase 0 - Logic Challenge - Total Digit (Rekursif)
...
function totalDigitRekursif(angka) {
    ...
    if (angkaString.length === 1) {
        ...
        return totalDigitRekursif(Number(angkaString.slice(1))) + Number(angkaString[0]);
    }
}
